...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "IoT · Embedded Systems · Software · Networking — Projects & experience." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Muhammed Nihal P A — Developer Portfolio" },
    ],
    links: [
      {
        rel: "stylesheet",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script defer src="https://static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"token": "e67bc3c796b54e8a8cda6871490c6b98"}'></script>
      </head>
      <body>
        {children}
        <Scripts />
